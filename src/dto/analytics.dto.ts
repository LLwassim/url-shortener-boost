...
export class ReferrerDataPoint {
  ...
  @ApiProperty({
    description: "Number of hits from this referrer",
    example: 450,
  })
  hits: number;
...
export class GeographicDataPoint {
  ...
  @ApiProperty({
    description: "Number of hits from this country",
    example: 650,
  })
  hits: number;
...
export class DeviceDataPoint {
  ...
  @ApiProperty({
    description: "Number of hits from this device type",
    example: 890,
  })
  hits: number;
...
export class BrowserDataPoint {
  ...
  @ApiProperty({
    description: "Number of hits from this browser",
    example: 720,
  })
  hits: number;
